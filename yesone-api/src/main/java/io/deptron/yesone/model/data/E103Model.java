...
import io.deptron.yesone.model.data.extension.IPensionAttr;
import io.deptron.yesone.model.data.extension.ISum;

public class E103Model extends DataModel implements IBusnid, IAccNo, IComCd, IPensionAttr, ISum, IAmt {
